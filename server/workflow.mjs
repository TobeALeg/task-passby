...
export const PROMPT_VERSION = "work-definition-v1.1";
    ...
    [
      {
        ...
        content:
          SYSTEM +
          "\nNow reconcile correction chains across ALL chunks in each work, compare different works and generalize. Return full schema. coverage must include every intermediate event key. SOURCE excerpts are optional; omit if exact text is not available. versions.schema=1.",
      },
