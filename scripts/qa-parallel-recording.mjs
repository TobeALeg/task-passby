...
try {
  ...
  await application.evaluate(async ({ app, ipcMain, BrowserWindow }, directory) => {
    ...
    globalThis.recordingQa = { service, threads, setHistoryError(value) { failHistory = value; } };
  ...
  console.log(JSON.stringify({ passed: true, parallelWorks: 3, automaticPanelRefresh: true, historyPagination: true, errorRecovery: true, screenshots: ["parallel-01-discovery.png", "parallel-02-history.png", "parallel-03-recording.png"] }, null, 2));
} finally {
